  ...
  return (
    <main className="p-4 h-[calc(100dvh-4rem)]">
      <section className="flex gap-4 h-1/2">
        <div className="backdrop-blur-xs border rounded-sm p-4 w-1/2 overflow-scroll bg-black/30">
        ...
        <div className="backdrop-blur-xs border rounded-sm p-4 w-1/4 overflow-scroll bg-black/30 flex flex-col gap-2">
